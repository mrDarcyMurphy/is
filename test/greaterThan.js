...
var one = ['newDate', 'positiveFloatString', 'positiveIntegerString', 'positiveFloat', 'positiveInteger', 'exponent', 'positiveExponent', 'infinity', 'positiveInfinity', 'infinityString', 'positiveInfinityString', 'hexadecimal', 'hexadecimalString', 'positiveHexadecimal']
var negativeOne = [ 'newDate', 'nil', 't', 'f', 'newBooleanTrue', 'newBooleanFalse', 'newArray', 'emptyArray', 'emptyString', 'whiteSpaceString', 'zeroString', 'negativeZero', 'zero', 'positiveZero', 'negativeZeroString', 'positiveZeroString', 'positiveFloatString', 'positiveIntegerString', 'positiveFloat', 'positiveInteger', 'exponent', 'positiveExponent', 'hexadecimal', 'positiveHexadecimal', 'infinity', 'positiveInfinity', 'infinityString', 'positiveInfinityString', 'hexadecimalString' ]
var greaterThanNothing = [ 'newDate', 't', 'newBooleanTrue', 'positiveFloatString', 'positiveIntegerString', 'positiveFloat', 'positiveInteger', 'exponent', 'positiveExponent', 'hexadecimal', 'positiveHexadecimal', 'infinity', 'positiveInfinity', 'infinityString', 'positiveInfinityString', 'hexadecimalString' ]
